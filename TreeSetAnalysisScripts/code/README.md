...
| edge6636-March-2023-no-metadata.trees                                         | Nexus     | Language phylogenies in Nexus format. 1000 posterior trees with 6636 tips each.                       |                | 003, 004_tree_slicing   |
| islands_transformed.R                                                         | RData     | Island polygons, used to determine which languages are on islands.                                    |                | 004, 007                |
| [~~***threat_data1.csv***~~]{.underline}                                      | CSV       | Threat assessment data                                                                                |                | 007                     |
